        ...
        ZStack {
            ...
            VStack(spacing: 8) {
                ...
                LayerPanel(
                    ...
                    accent: Color(red: 0.64, green: 0.74, blue: 0.55),
                    objects: [
                ...
                LayerPanel(
                    ...
                    accent: Color(red: 0.70, green: 0.56, blue: 0.68),
                    objects: [
        ...
        VStack(spacing: 0) {
            HStack {
                Text(title)
                    ...
                    .tracking(1.0)
                    .foregroundStyle(Color(red: 0.62, green: 0.72, blue: 0.80).opacity(0.82))
...
struct GlassModuleObject: View {
    ...
    var body: some View {
        ...
        .overlay {
            RoundedRectangle(cornerRadius: 5)
                .stroke(accent.opacity(0.62), lineWidth: 0.65)
        }
        .overlay {
            RoundedRectangle(cornerRadius: 5)
